...
#define ISPCPU_RDR_TIMESTAMP_FPGAMOD (1 << 30)
#define ISPCPU_RDR_FORCE_UART        (1 << 29)
#define ISPCPU_RDR_LEVEL_WATCHDOG    (1 << 28)
...
#define ISPCPU_RDR_RESERVE_09        (1 << 9)
#define ISPCPU_RDR_RESERVE_08        (1 << 8)
#define ISPCPU_RDR_LEVEL_DEBUG_ALGO  (1 << 7)
#define ISPCPU_RDR_LEVEL_ERR_ALGO    (1 << 6)
#define ISPCPU_RDR_LEVEL_TRACE       (1 << 5)
#define ISPCPU_RDR_LEVEL_DUMP        (1 << 4)
#define ISPCPU_RDR_LEVEL_DBG         (1 << 3)
#define ISPCPU_RDR_LEVEL_INFO        (1 << 2)
#define ISPCPU_RDR_LEVEL_WARN        (1 << 1)
#define ISPCPU_RDR_LEVEL_ERR         (1 << 0)
#define ISPCPU_RDR_LEVEL_MASK        (0x1FFFFFFF)
#define RDR_CHOOSE_TYPE              (RDR_LOG_TRACE | RDR_LOG_LAST_WORD)
#define ISPCPU_DEFAULT_LOG_LEVEL     (ISPCPU_RDR_LEVEL_ERR | ISPCPU_RDR_LEVEL_WARN | ISPCPU_RDR_LEVEL_INFO |\
                                     ISPCPU_RDR_LEVEL_ERR_ALGO | ISPCPU_RDR_LEVEL_DEBUG_ALGO)
